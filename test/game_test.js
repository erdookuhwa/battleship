...
// for pending tests, use xdescribe or only expectation w/out the function in it('') or nothing inside the function() {} if marked w/ xdescribe
    describe('checkGameStatus', function() {
        var checkGameStatus = require('../game_logic/game_instance').checkGameStatus;
